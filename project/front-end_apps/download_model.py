...
def main() -> None:
    ...
    while(True):
        ...
        if key == menu_options[0]:
            ...
            open_clip.create_model_and_transforms('ViT-g-14', pretrained='laion2B-s12B-b42K')
            open_clip.get_tokenizer('ViT-g-14')
            print("Download complete!")
            
        elif key == menu_options[1]:
            print("Downloading model...")
            open_clip.create_model_and_transforms('ViT-H-14', pretrained='laion2B-s32B-b79K')
            open_clip.get_tokenizer('ViT-H-14')
            print("Download complete!")

        elif key == menu_options[2]:
            print("Downloading model...")
            open_clip.create_model_and_transforms('ViT-L-14', pretrained='laion2B-s32B-b82K')
            open_clip.get_tokenizer('ViT-L-14')
            print("Download complete!")
        
        elif key == menu_options[3]:
            print("Downloading model...")
            open_clip.create_model_and_transforms('ViT-B-16', pretrained='laion2B-s34B-b88K')
