...
def save(filename: str = CONFIG_FILE) -> None:
    ...
    with open(filename, "w") as file:
        json.dump({"PROCESS_ONLINE": PROCESS_ONLINE, "FPS_RATE": FPS_RATE}, file)
...
menu_prompt = (
    "1: Toggle Online/Offline Computation (currently: {})\n"
...
def main() -> None:
    ...
    """
    while True:
        print(menu_prompt.format("online" if PROCESS_ONLINE else "offline", FPS_RATE))
