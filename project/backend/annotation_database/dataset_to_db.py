...
from multiprocessing import (
    Pool,
)  # Used to create a pool of worker processes in order to parallelize the execution of some task.
...
if __name__ == "__main__":
    ...
    def send(file):
        ...
        send_to_db_server(
            os.path.join(image_dataset_dir, file),
            annotations,
    ...
    print(
        "Complete"
    )  # The script prints "Complete" when all files have been processed.
