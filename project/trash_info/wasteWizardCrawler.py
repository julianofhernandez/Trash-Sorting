...
def main():
    ...
    df = pd.DataFrame(list(zip(names, categories, scores)),
                    columns=['item', 'category', 'score'])
...
def load_selenium():
    ...
    driver.get('http://www.cityofsacramento.org/public-works/rsw/waste-wizard#!rc-cpage=wizard_material_list')
    time.sleep(5)
    return driver
